---
title: "Polars Support"
description: "rusket accepts polars.DataFrame natively alongside pandas, via the Arrow-backed zero-copy path."
---
...
<Tip>
**Lazy frames** — pass `.collect()` before passing it to `AutoMiner` if you have a `LazyFrame`:
```python
