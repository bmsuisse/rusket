...
Template JSON: /Users/dominikpeter/DevOps/rusket/.desloppify/external_review_sessions/ext_20260312_194859_84ed4d2b/review_result.template.json
Output JSON path: /Users/dominikpeter/DevOps/rusket/.desloppify/external_review_sessions/ext_20260312_194859_84ed4d2b/review_result.json
...
then read the actual source code.
  ...
  desloppify show security --no-budget      # 105 findings
...
then read the actual source code.
  ...
  desloppify show test_coverage --no-budget      # 30 findings
...
1. Keep `session.id` exactly `ext_20260312_194859_84ed4d2b`.
2. Keep `session.token` exactly `02e0e5cedee2977d4b2122daf02c07e7`.
